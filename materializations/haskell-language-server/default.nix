  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hls-floskell-plugin".revision = (((hackage."hls-floskell-plugin")."1.0.1.0").revisions).default;
        ...
        "hls-retrie-plugin".revision = (((hackage."hls-retrie-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-refine-imports-plugin".revision = (((hackage."hls-refine-imports-plugin")."1.0.1.0").revisions).default;
        ...
        "hls-graph".revision = (((hackage."hls-graph")."1.6.0.0").revisions).default;
        ...
        "hls-fourmolu-plugin".revision = (((hackage."hls-fourmolu-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-plugin-api".revision = (((hackage."hls-plugin-api")."1.3.0.0").revisions).default;
        ...
        "hls-stylish-haskell-plugin".revision = (((hackage."hls-stylish-haskell-plugin")."1.0.1.0").revisions).default;
        "aeson".revision = (((hackage."aeson")."1.5.6.0").revisions).default;
        "aeson".flags.fast = false;
        "aeson".flags.bytestring-builder = false;
        "aeson".flags.developer = false;
        "aeson".flags.cffi = false;
        "hls-hlint-plugin".revision = (((hackage."hls-hlint-plugin")."1.0.3.0").revisions).default;
        ...
        "ghcide".revision = (((hackage."ghcide")."1.6.0.1").revisions).default;
        ...
        "hls-tactics-plugin".revision = (((hackage."hls-tactics-plugin")."1.6.1.0").revisions).default;
        "hls-tactics-plugin".flags.pedantic = false;
        "hls-ormolu-plugin".revision = (((hackage."hls-ormolu-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-call-hierarchy-plugin".revision = (((hackage."hls-call-hierarchy-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-explicit-imports-plugin".revision = (((hackage."hls-explicit-imports-plugin")."1.0.2.0").revisions).default;
        ...
        "hls-module-name-plugin".revision = (((hackage."hls-module-name-plugin")."1.0.1.0").revisions).default;
        ...
        "hls-eval-plugin".revision = (((hackage."hls-eval-plugin")."1.2.1.0").revisions).default;
        ...
        "hls-pragmas-plugin".revision = (((hackage."hls-pragmas-plugin")."1.0.2.0").revisions).default;
        "hls-brittany-plugin".revision = (((hackage."hls-brittany-plugin")."1.0.2.0").revisions).default;
        "Only".revision = (((hackage."Only")."0.1").revisions).default;
        "hls-alternate-number-format-plugin".revision = (((hackage."hls-alternate-number-format-plugin")."1.0.1.0").revisions).default;
        "hls-class-plugin".revision = (((hackage."hls-class-plugin")."1.0.2.0").revisions).default;
